...
describe('TC23.2 - Review Indicates It Is From Admin', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('TC23.2 - Review Indicates It Is From Admin', async function() {
    ...
    {
      const elements = await driver.findElements(By.xpath("//strong"))
